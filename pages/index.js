            ...
            <div className={ classes.copyCentered }>
              ...
              <div>
                ...
                <div className={ classes.socials }>
                  <a className={ `${classes.socialButton}` } href='https://github.com/clctclub/networklist-org.git' target='_blank' rel="noopener noreferrer" >
                  ...
                  <a className={ `${classes.socialButton}` } href='https://twitter.com/clctclub' target='_blank' rel="noopener noreferrer" >
