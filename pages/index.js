        ...
        <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              <div className={ classes.copyPart }>
                <img height={240} width={240} src={'/img/Icon_crystal@3x.png'} alt={'twitter'}/>
                <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>{'CHAINLIST.\nCOOL'}</span></Typography>
              </div>
              <div>
                ...
                <div className={ classes.socials }>
                  <a className={ `${classes.socialButton}` } href='https://github.com/clctclub/networklist-org' target='_blank' rel="noopener noreferrer" >
                  ...
                  <Typography variant='subtitle1' className={ classes.version }>{`Original project by Chainlist.org\n(April 3rd shutdown)`}</Typography>
                  <a className={ `${classes.socialButton}` } href='https://twitter.com/ChainlistCool' target='_blank' rel="noopener noreferrer" >
                    <img height={24} width={24} src={'/img/Twitter - Original@3x.png'} alt={'twitter'}/>
                    <Typography variant='body1' className={ classes.sourceCode }>FOLLOW @CHAINLISTCOOL</Typography>
                  </a>
                  <Typography style={{color:'#fff', marginTop:20}} variant='body1' className={ classes.sourceCode }>POWERED BY</Typography>
                  <a href='https://clct.club/' target='_blank' rel="noopener noreferrer">
                    <img style={{marginTop:20}} height={46} width={169} src={'/img/CLCT-LOGO@3x.png'} alt={'clct'}/>
                  </a>
                </div>
              </div>
            </div>
